...
class AfcFile {
    ...
    conf2xml(config) {
        ...
        const map = {
            ...
            'Model.Interface.ClassicSkinVWLines.Line3': () => lineContent('ClassicSkinVWLine3'),
            'Model.Interface.ClassicSkinVWLines.Line4': () => lineContent('ClassicSkinVWLine4'),

            'Model.Interface.ClassicSkinTCLines.Line1': () => lineContent('ClassicSkinTCLine1'),
            'Model.Interface.ClassicSkinTCLines.Line2': () => lineContent('ClassicSkinTCLine2'),
            'Model.Interface.ClassicSkinTCLines.Line3': () => lineContent('ClassicSkinTCLine3'),
            'Model.Interface.ClassicSkinTCLines.Line4': () => lineContent('ClassicSkinTCLine4'),

            'Model.Interface.CircleSkinVWLines.Line1': () => lineContent('CircleSkinVWLine1'),
            'Model.Interface.CircleSkinVWLines.Line2': () => lineContent('CircleSkinVWLine2'),
            'Model.Interface.CircleSkinVWLines.Line3': () => lineContent('CircleSkinVWLine3'),

            'Model.Interface.CircleSkinTCLines.Line1': () => lineContent('CircleSkinTCLine1'),
            'Model.Interface.CircleSkinTCLines.Line2': () => lineContent('CircleSkinTCLine2'),
            'Model.Interface.CircleSkinTCLines.Line3': () => lineContent('CircleSkinTCLine3'),
            ...
            'Model.Interface.SmallSkinVWLines.Line1': () => lineContent('SmallSkinVWLine1'),
            'Model.Interface.SmallSkinVWLines.Line2': () => lineContent('SmallSkinVWLine2'),
