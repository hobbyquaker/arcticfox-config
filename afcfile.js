...
class AfcFile {
    ...
    conf2xml(config) {
        ...
        const map = {
            ...
            'Model.General.Profiles[0].Flags.IsCelcius': config.profiles[0].IsCelcius,
            ...
            'Model.General.Profiles[0].PIRegulator.IsEnabled': config.profiles[0].PIRegulatorIsEnabled,
            ...
            'Model.General.Profiles[1].Flags.IsCelcius': config.profiles[1].IsCelcius,
            ...
            'Model.General.Profiles[1].PIRegulator.IsEnabled': config.profiles[1].PIRegulatorIsEnabled,
            ...
            'Model.General.Profiles[2].Flags.IsCelcius': config.profiles[2].IsCelcius,
            ...
            'Model.General.Profiles[2].PIRegulator.IsEnabled': config.profiles[2].PIRegulatorIsEnabled,
            ...
            'Model.General.Profiles[3].Flags.IsCelcius': config.profiles[3].IsCelcius,
            ...
            'Model.General.Profiles[3].PIRegulator.IsEnabled': config.profiles[3].PIRegulatorIsEnabled,
            ...
            'Model.General.Profiles[4].Flags.IsCelcius': config.profiles[4].IsCelcius,
            ...
            'Model.General.Profiles[4].PIRegulator.IsEnabled': config.profiles[4].PIRegulatorIsEnabled,
            ...
            'Model.General.Profiles[5].Flags.IsCelcius': config.profiles[5].IsCelcius,
            ...
            'Model.General.Profiles[6].Flags.IsCelcius': config.profiles[6].IsCelcius,
            ...
            'Model.General.Profiles[6].PIRegulator.IsEnabled': config.profiles[6].PIRegulatorIsEnabled,
            ...
            'Model.General.Profiles[7].Flags.IsCelcius': config.profiles[7].IsCelcius,
            ...
            'Model.General.Profiles[7].PIRegulator.IsEnabled': config.profiles[7].PIRegulatorIsEnabled,
            ...
            'Model.Interface.IsPowerStep1W': config.IsPowerStep1W,
            'Model.Interface.IsTemperatureStep1C2F': config.IsTemperatureStep1C2F,
            ...
            'Model.Interface.IsClassicMenu': config.IsClassicMenu,
            'Model.Interface.ClockType': enumClockType[config.ClockType],
            'Model.Interface.IsClockOnMainScreen': config.IsClockOnMainScreen,
            'Model.Interface.ScreensaveDuration': enumScreenProtectionTime[config.ScreensaveDuration],
    ...
    xml2conf(xml, cb) {
        ...
        const map = {
            ...
            'Model.General.Profiles[0].Flags.IsCelcius': (config, val) => config.profiles[0].IsCelcius = bool(val),
            ...
            'Model.General.Profiles[0].PIRegulator.IsEnabled': (config, val) => config.profiles[0].PIRegulatorIsEnabled = bool(val),
            ...
            'Model.General.Profiles[1].Flags.IsCelcius': (config, val) => config.profiles[1].IsCelcius = bool(val),
            ...
            'Model.General.Profiles[1].PIRegulator.IsEnabled': (config, val) => config.profiles[1].PIRegulatorIsEnabled = bool(val),
            ...
            'Model.General.Profiles[2].PIRegulator.IsEnabled': (config, val) => config.profiles[2].PIRegulatorIsEnabled = bool(val),
            ...
            'Model.General.Profiles[3].Flags.IsCelcius': (config, val) => config.profiles[3].IsCelcius = bool(val),
            ...
            'Model.General.Profiles[3].PIRegulator.IsEnabled': (config, val) => config.profiles[3].PIRegulatorIsEnabled = bool(val),
            ...
            'Model.General.Profiles[4].PIRegulator.IsEnabled': (config, val) => config.profiles[4].PIRegulatorIsEnabled = bool(val),
            ...
            'Model.General.Profiles[5].PIRegulator.IsEnabled': (config, val) => config.profiles[5].PIRegulatorIsEnabled = bool(val),
            ...
            'Model.General.Profiles[6].Flags.IsCelcius': (config, val) => config.profiles[6].IsCelcius = bool(val),
            ...
            'Model.General.Profiles[6].PIRegulator.IsEnabled': (config, val) => config.profiles[6].PIRegulatorIsEnabled = bool(val),
            ...
            'Model.General.Profiles[7].Flags.IsCelcius': (config, val) => config.profiles[7].IsCelcius = bool(val),
            ...
            'Model.General.Profiles[7].PIRegulator.IsEnabled': (config, val) => config.profiles[7].PIRegulatorIsEnabled = bool(val),
            ...
            'Model.Interface.IsPowerStep1W': (config, val) => config.IsPowerStep1W = bool(val),
            'Model.Interface.IsTemperatureStep1C2F': (config, val) => config.IsTemperatureStep1C2F = bool(val),
            ...
            'Model.Interface.IsClassicMenu': (config, val) => config.IsClassicMenu = bool(val),
            ...
            'Model.Interface.ScreensaveDuration': (config, val) => config.ScreensaveDuration = re(enumScreenProtectionTime, val),
